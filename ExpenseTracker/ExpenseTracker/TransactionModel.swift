...
extension Category {
    static let autoAndTransport = Category(id: 1, name: "Auto and Transpot", icon: .car_alt)
    ...
    static let moviesAndDVDs = Category(id: 301, name: "Movies and DVDs", icon: .film, mainCategoryId: 2)
    static let bankFees = Category(id: 401, name: "Bank Fee", icon: .hand_holding_usd, mainCategoryId: 4)
